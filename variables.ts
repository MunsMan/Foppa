const variables = {
    ...
    FUNCTION_EXECUTION_COUNTER_ARN:
        'arn:aws:dynamodb:us-east-1:807699729275:table/FunctionExecutionCounter',
    LOGGING_BUCKET_NAME: 'foppa-logs',
    FOPPA_BUCKET_NAME: 'foppa',
    SERVICE_URL: 'https://inxhq4mmg6.execute-api.us-east-1.amazonaws.com',
} as const;
